...
submitbtn = Button(root, text="Submit", bg="DodgerBlue2", fg="white", font=('arial', 15, 'bold'), command=submitexpense)
submitbtn.grid(row=4, column=1, padx=7, pady=7)

viewtn = Button(root, text="View Expenses", bg="DodgerBlue2", fg="white", font=('arial', 15, 'bold'), command=viewexpense)
viewtn.grid(row=5, column=1, padx=7, pady=7)

Etable = ttk.Treeview(root, columns=("Date", "Name", "Title", "Expense"), show='headings', height=20)
Etable.grid(row=8, column=0, padx=7, pady=7)

Etable.heading("Date", text="Date")
Etable.heading("Name", text="Name")
Etable.heading("Title", text="Title")
Etable.heading("Expense", text="Expense")
